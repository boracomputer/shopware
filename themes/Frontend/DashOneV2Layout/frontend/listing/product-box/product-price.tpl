...
<div class="product--price">
    ...
    {block name='frontend_listing_box_article_price_default'}
        <span class="price--default is--nowrap{if $sArticle.has_pseudoprice} is--discount{/if}">
            ...
            <span class="pricelayer shadow">&euro; {$price.0}<sup>{$price.1}</sup></span>
            <span class="pricelayer outline">&euro; {$price.0}<sup>{$price.1}</sup></span>
            <span class="pricelayer fill">&euro; {$price.0}<sup>{$price.1}</sup></span>
            {*<svg>
