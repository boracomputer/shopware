{if $sEmotions|@count > 0}
    {foreach $sEmotions as $emotion}
        ...
        {if $shopID|intval != $emotion.attribute.shopid|intval && $emotion.attribute.shopid!=0 && $emotion.attribute.shopid!=''}
            {continue}
        {/if}
                                ...
                                <div class="{$itemCls}" style="{$itemStyle}">
                                    ...
                                    {block name="widgets/emotion/index/inner-element"}
                                        ...
                                        {elseif $template == 'component_banner_slider'}
                                            {include file="widgets/emotion/components/component_banner_slider.tpl" shopId=$shopId}
